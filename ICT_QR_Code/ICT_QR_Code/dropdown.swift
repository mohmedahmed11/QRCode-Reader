...
protocol ArrowPickerViewDelegate: class {
    func arrowPickerDone(row: Int, button: UITextField)
    func arrowPickerDidSelectRow(row: Int, button: UITextField)
}
...
class ArrowPickerView: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private var selectedButon: UITextField!
    ...
    // MARK: Show picker
    func show(pickerArray: [String], inButton selectedButon: UITextField) {
        ...
        setPickerPosition(currentValue: self.selectedButon.text)
    ...
    @objc func pickerDone() {
        ...
        if pickerArray.count > 0 {
            ...
            selectedButon?.text = pickerArray[row]
            //        .setTitle(pickerArray[row], for: .normal)
